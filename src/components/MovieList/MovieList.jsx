...
function MovieList() {
  ...
  // this was beginning to morph into the thing I hoped it would be
  // a function that somehow gets all movie and relevant genre data
  // to the fancy Saga that I halfway made in the index.js
